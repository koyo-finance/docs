...
Just input the **number of tokens** you want to lock.

_Beware that setting a higher amount than you have will result in a failed transaction and you'll lose eth that you paid for gas._
